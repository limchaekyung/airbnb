    ...
    return (
        <div className='home'>
            ...
            <div className="home__section">
                ...
                <Card src="https://a0.muscache.com/im/pictures/fdb46962-10c1-45fc-a228-d0b055411448.jpg?im_w=720" title="Entire homes" description="Comfortable private places, with room for friends of family." />
            </div>
            <div className="home__section">
